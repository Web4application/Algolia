...
CFLAGS=-WM -O2 -d -q -w-8057 -w-8012 -Iinclude -Iwin32\include -nsrc -DHPDF_DLL_MAKE 
CFLAGS_DEMO=-WM -O2 -d -q -w-8057 -w-8012 -Iinclude -Iwin32\include -D__WIN32__ -DHPDF_DLL
CFLAGS_EXE=-e
LDFLAGS=/Lwin32\bcc32 libpng.lib zlib.lib 
LDFLAGS_DEMO1=/L. /Lwin32\bcc32 libhpdf.lib 
LDFLAGS_DEMO2=
DEFNAME=
